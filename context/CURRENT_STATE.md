...
Repo-owned verification is green: `npm run verify:launch-local` returned direct exit 0; 93 Vitest files / 642 checks, 15 Edge Function entrypoints and 52 Deno tests across seven files, 48/48 runtime compatibility, 326 public files × 24 claim rules, production build/browser smoke, public exposure, proof replay, bundle budget, tracked-secret scan, and strict public sanitization all pass. The doctor is finalized after derived closeout receipts are refreshed.
