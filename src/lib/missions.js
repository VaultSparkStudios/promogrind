// Daily Grind Missions — 3 deterministic daily missions seeded from the date
...
const POOL = [
  ...
  { id: 'run_arb',        label: 'Hunt for arbs',         desc: 'Use the Arb 2-Way Calculator',            xp: 8,  nav: '/arb-2way',         check: () => todayFlag('pg_used_arb') },
  ...
  { id: 'check_insights', label: 'Check your edge',       desc: 'Review your performance in Track Insights', xp: 8, nav: '/edge-dashboard', check: () => todayFlag('pg_insights_visited') },
