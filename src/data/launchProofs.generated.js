  ...
  "proofs": {
    ...
    "stripeSmoke": {
      ...
      "evidenceRequired": [
        ...
        "customer portal opens for the purchaser",
        "webhook lifecycle observed without errors"
      ],
      "evidence": []
    },
    "friendBeta": {
      ...
      "evidenceRequired": [
        ...
        "tester completed at least one top calculator",
        "tester reviewed sportsbook CTA behavior",
        "tester reviewed pricing/free-account messaging"
      ],
      "evidence": [
        {
          "date": "2026-04-24",
    ...
    "brevoDelivery": {
      ...
      "evidenceRequired": [
        "Brevo inbound or forwarding route is active",
        "SPF and DKIM are verified",
        "redacted test message reaches the destination mailbox"
      ],
      "evidence": []
    },
    "supabaseDeployment": {
      ...
      "evidenceRequired": [
        "quota migration applied to fjnpzjjyhnpmunfoycrp",
        "five provider functions deployed",
        "authenticated quota exhaustion smoke returns a hard 429"
      ],
      "evidence": []
    },
    "captureConfig": {
      ...
      "evidenceRequired": [
        "production page exposes non-placeholder browser-safe configuration",
        "capture submission succeeds",
        "lead row is observable without exposing private credentials"
      ],
      "evidence": []
    }
  }
