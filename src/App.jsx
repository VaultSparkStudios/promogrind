...
export default function App() {
  ...
  return (
    ...
    <div style={{fontFamily:font,fontSize:13,color:K.tx,background:K.bg,minHeight:"100vh"}}>
      ...
      <MobileBottomNav gi={gi} goTo={goTo} tabs={TABS} onOpenDrawer={() => setShowMobileNavDrawer(true)}/>
      <MobileNavDrawer open={showMobileNavDrawer} onClose={() => setShowMobileNavDrawer(false)} tabs={TABS} gi={gi} goTo={goTo} activeSlug={slug}/>
