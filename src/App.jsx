...
export default function App() {
  ...
  return (
    ...
    <div style={{fontFamily:font,fontSize:13,color:K.tx,background:K.bg,minHeight:"100vh"}}>
      ...
      <MobileBottomNav gi={gi} goTo={goTo} tabs={TABS} onOpenDrawer={() => setMobileDrawerOpen(true)}/>
      <MobileNavDrawer isOpen={mobileDrawerOpen} onClose={() => setMobileDrawerOpen(false)} tabs={TABS} gi={gi} goTo={goTo}/>
