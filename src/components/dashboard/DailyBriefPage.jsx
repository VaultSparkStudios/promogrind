...
import { getTodayContext } from "../../dashboard/today.js";
...
export default function DailyBriefPage() {
  ...
  const { dashboardSnapshot, studioSnapshot, alertPlan } = buildOperatorSurfaceState({
    appData,
    schedule: PROMO_SCHED,
    now: today,
  });
    ...
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "24px 16px", fontFamily: font }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(340px,1fr))", gap: 14 }}>
        ...
        {dashboardSnapshot.topPlaybook?.applicable && dashboardSnapshot.topPlaybook.playbook && (() => {
          const pb = dashboardSnapshot.topPlaybook.playbook;
          const fitLine = dashboardSnapshot.topPlaybook.reasons?.map((r) => r.text).join(" · ") || `fit score ${dashboardSnapshot.topPlaybook.fitScore}`;
          return (
