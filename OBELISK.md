# Obelisk Posture — PromoGrind

**Canon:** CANON-021 · D-S119.2
**Project slug:** `promogrind`
**Declared at:** {{DATE}}
**Owner:** {{OWNER}}
...
> Auto-detected by `node scripts/obelisk-inventory.mjs --slug promogrind`. Run it and paste/summarize findings here.
