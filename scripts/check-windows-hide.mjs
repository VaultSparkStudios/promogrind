...
// Any acquisition of node:child_process (static import, require, or dynamic
// import()) is a direct escape from the hardened wrapper. Keep this deliberately
// syntax-shaped so prose mentions do not become violations.
